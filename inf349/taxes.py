...
# Fonction pour calculer le montant de la taxe (en dollars, float)
...
# Fonction pour calculer le montant total incluant les taxes (en dollars)
def calculate_total_with_tax(subtotal, province):
    """Calcule le total incluant la taxe pour un sous-total en dollars.

    Args:
        subtotal (float): montant en dollars
        province (str): code de la province

    Returns:
        float: total incluant taxes, arrondi à 2 décimales
    """
